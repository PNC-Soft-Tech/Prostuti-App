...
class SharedQuestionCircleWidget extends StatelessWidget {
  ...
  final bool isSelected; // Replace with actual logic to determine if the question is selected
  final bool showCorrectAns; // Replace with actual logic to determine if the question is selected
